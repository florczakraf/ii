...
let graphics () =
  ...
  in Draw.draw (module S) s; ignore (S.search 8 s);
     Draw.draw (module S) s; let s = S.delete 8 s
  in Draw.draw (module S) s; let s = S.delete 2 s
  in Draw.draw (module S) s; let s = S.delete 5 s
  in Draw.draw (module S) s; let s = S.delete 7 s
  in Draw.draw (module S) s; let s = S.delete 1 s
  in Draw.draw (module S) s; let s = S.delete 4 s
